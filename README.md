...
SAÉ1 Introduction aux systèmes
...
```
cd existing_repo
git remote add origin https://iut-info.univ-reims.fr/gitlab/coud0011/MS103.git
git branch -M main
...
- [ ] [Set up project integrations](https://iut-info.univ-reims.fr/gitlab/coud0011/MS103/-/settings/integrations)
